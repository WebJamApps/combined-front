...
describe('the Library module', () => {
  ...
  it('runs showSlides when component is attached', (done) => {
    ...
    document.body.innerHTML = '<div id="lSlide1"><div></div></div><div id="libslideshow1"><div class="mySlides">' +
    '<img src="https://static.pexels.com/photos/2422/sky-earth-galaxy-universe.jpg" /></div></div> <div id="lSlide2">' +
    '<div></div></div><div id="libslideshow"><div class="mySlides">' +
